...
def main() -> int:
    ...
    parser.add_argument("--open", "-open", action="store_true", help="Open browser automatically when serving.")
    ...
    try:
        ...
        raise RuntimeError("Missing runtime dependencies. Run fetch_previewer.py again.") from exc
